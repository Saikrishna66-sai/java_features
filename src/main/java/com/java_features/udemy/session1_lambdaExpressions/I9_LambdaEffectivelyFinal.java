...
public class I9_LambdaEffectivelyFinal {
...
String name="";
    ...
    public static void main(String[] args) {
        ...
        Predicate<String> lambda = s -> {
            //x++;
            new I9_LambdaEffectivelyFinal().name = "Kennedy";  // instance/class vars are ok
        ...
        new I9_LambdaEffectivelyFinal().name = "Sean"; // instance/class vars are ok
