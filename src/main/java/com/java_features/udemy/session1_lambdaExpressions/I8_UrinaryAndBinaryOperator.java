package com.java_features.udemy.session1_lambdaExpressions;
...
public class I8_UrinaryAndBinaryOperator {

	public static void main(String[] args) {
		I8_UrinaryAndBinaryOperator fiAPI = new I8_UrinaryAndBinaryOperator();
//	        fiAPI.predicate();
//	        fiAPI.supplier();
		fiAPI.consumer();
//	        fiAPI.function();
//	        fiAPI.unaryBinaryOperator();
	...
	public void unaryBinaryOperator() {
		...
		// BinaryOperator<T> extends BiFunction<T, T, T> is a functional interface i.e.
		// one abstract method:
		// T apply(T t1, T t2)
